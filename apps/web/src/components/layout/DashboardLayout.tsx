...
// Derived tutor access (role or feature flags)
function canSeeTutorMenusLocal(user: any, profile: any): boolean {
  const isTutorRole = profile?.role === "tutor" || user?.role === "tutor";
...
const DashboardLayout: React.FC = () => {
  ...
  const isTutorAccess = canSeeTutorMenusLocal(user, profile);

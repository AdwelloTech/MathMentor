...
const StudentProfile: React.FC = () => {
  ...
  const { gradeLevels, loading: gradeLevelsLoading, error: gradeLevelsError } = useGradeLevels();
        ...
        if (profileError) {
         ...
         if (profileData) {
           setFormData({
             ...
             hasLearningDisabilities: profileData.has_learning_disabilities || false,
             learningNeedsDescription: profileData.learning_needs_description ?? '',
           });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData = {
        ...
        learning_needs_description: formData.hasLearningDisabilities ? formData.learningNeedsDescription || null : null,
      ...
      if (updateProfile) {
        await updateProfile({
          ...
          learning_needs_description: updateData.learning_needs_description || undefined,
        });
      }
            ...
            <div className="form-group">
              ...
              {gradeLevelsLoading ? (
                <div className="input flex items-center">
                  ...
                  <span className="ml-2 text-gray-500">Loading grade levels...</span>
                </div>
              ) : gradeLevelsError ? (
                ...
                >
                  ...
                  {Object.entries(groupedGradeLevels).map(([category, levels]) => (
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="form-group">
              <div className="flex items-start">
                ...
                />
                <div className="ml-3">
                  <label htmlFor="hasLearningDisabilities" className="text-sm font-medium text-gray-900 cursor-pointer">
                    I have learning disabilities or special needs
                  </label>
                  <p className="text-xs text-gray-500 mt-1">
                    Check this box if you have any learning challenges that we should be aware of
                  </p>
                </div>
              </div>
            </div>
            ...
            {formData.hasLearningDisabilities && (
              ...
              >
                <label htmlFor="learningNeedsDescription" className="form-label">
                ...
                />
                <p className="mt-1 text-xs text-gray-500">
                  This information will help us provide personalized learning support and accommodations.
                </p>
              </motion.div>
            )}
          </div>

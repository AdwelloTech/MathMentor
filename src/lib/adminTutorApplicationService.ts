      ...
      const transformedApplications = data?.map((app: any) => {
        try {
          return {
            ...
            specializes_learning_disabilities: app.specializes_learning_disabilities || false,
          ...
          console.error('Error transforming application data:', transformError);
          return null;
        }
  ...
  static async getApplicationById(applicationId: string): Promise<TutorApplication | null> {
    try {
      ...
      const application: TutorApplication = {
        ...
        specializes_learning_disabilities: data.specializes_learning_disabilities || false,

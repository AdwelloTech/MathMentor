...
const { Schema } = mongoose;
  ...
  set_id: { type: String, ref: 'FlashcardSets', required: true },
  front_text: { type: String, required: true },
  back_text: { type: String, required: true },
  card_order: { type: Number, default: 0 }
}
,
      {
    ...
    export default mongoose.models.Flashcards || mongoose.model('Flashcards', schema);

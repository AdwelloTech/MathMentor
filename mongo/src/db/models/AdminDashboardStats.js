...
const { Schema } = mongoose;
  ...
  stat_type: { type: String, required: true, trim: true },
  stat_value: { type: Schema.Types.Mixed, required: true },
  stat_date: { type: Date, required: true }
}
,
      {
        timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' },
        collection: 'admin_dashboard_stats'
      }
    );
    export default mongoose.models.AdminDashboardStats || mongoose.model('AdminDashboardStats', schema);

...
const TutorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const _appStatusEff = application?.application_status ?? (hasTutorFlags ? "approved" : "n/a");
    const _idStatusEff = idVerification?.verification_status ?? (hasTutorFlags ? "approved" : "n/a");
    console.log(
  ...
  const isIDVerificationApproved =
    idVerification?.verification_status === "approved" || hasTutorFlags;
  ...
  // Tutor features are enabled if application+ID are approved OR profile has tutor flags
  const areTutorFeaturesEnabled = (
    (isApprovedTutor && isIDVerificationApproved) ||
    profile?.features?.tutor_subscription === true ||
    profile?.features?.tutor === true ||
    profile?.features?.tutor_dashboard === true ||
    profile?.role === "tutor" ||

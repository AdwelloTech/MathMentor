    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-6xl w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
                  ...
                  >
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-blue-700">
                        ...
                        and upload your CV to start tutoring.
                      </p>
                    </div>
          ...
          <div className="bg-[#144d23] text-white p-8 lg:p-12 flex flex-col justify-center">
            <div className="max-w-md mx-auto w-full">
              {/* Promotional Header */}
              <div className="mb-4 text-center">
                ...
                <p className="text-gray-200 leading-relaxed">
                  ChatGPT said: Experience the future of learning—connect with
                  expert tutors, access premium materials, and track your
                  progress with smart analytics.
                </p>
              </div>
              <img

...
const StudentDashboard: React.FC = () => {
  ...
  const filteredTutors = selectedSpecialization === 'all' 
    ? tutors 
    : tutors.filter(tutor => 
        tutor.specialization.toLowerCase().includes(selectedSpecialization.replace('-', ' '))
      );
      ...
      <div className="px-6 py-8 lg:px-8 space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-emerald-100">
                {packageInfo.sessionsRemaining} of {packageInfo.totalSessions} sessions remaining
              </p>
            ...
            <div className="text-right">
              <div className="text-3xl font-bold">{packageInfo.sessionsRemaining}</div>
        ...
        <motion.div variants={itemVariants} className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Find a Tutor Now</h2>
                <p className="text-gray-600">Book a 15-minute session with expert tutors</p>
              </div>
            </div>
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
                      ...
                      <p className="text-blue-100 text-sm">{tutor.specialization}</p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-lg font-bold text-green-600">{tutor.price}</span>
                    </div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">My Upcoming Sessions</h3>
            <p className="text-gray-600 text-sm mb-4">View and manage your scheduled lessons</p>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">My Past Sessions</h3>
            <p className="text-gray-600 text-sm mb-4">Review your completed lessons and notes</p>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">Access your study materials and notes</p>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">Schedule a detailed consultation session</p>
          ...
          <div className="p-6">
            {upcomingSessions.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Book your first session with a tutor to get started!</p>
              </div>
            )}
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { name: 'Total Sessions', value: '24', icon: VideoCameraIcon, color: 'from-blue-500 to-blue-600' },
            { name: 'Hours Learned', value: '36', icon: ClockIcon, color: 'from-green-500 to-emerald-600' },
            { name: 'Tutors Worked With', value: '8', icon: UserGroupIcon, color: 'from-purple-500 to-pink-600' },
            { name: 'Average Rating', value: '4.8', icon: StarIcon, color: 'from-yellow-500 to-orange-600' }
          ].map((stat, index) => (
            <motion.div
              key={stat.name}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: 'Perfect Week', desc: '7 days of consistent learning', icon: '⭐', color: 'bg-yellow-500' },
                { title: 'Math Master', desc: 'Completed Algebra module', icon: '🏆', color: 'bg-orange-500' },
                { title: 'Quick Learner', desc: '5 sessions this week', icon: '🚀', color: 'bg-red-500' }
                ...
                >
                  ...
                  <p className="text-sm text-yellow-100">{achievement.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        >
          ...
          >
            <p className="text-sm">
              💡 <strong>Pro Tip:</strong> Take short breaks between study sessions to maintain focus and retention. 
              The Pomodoro Technique (25 minutes study + 5 minutes break) can significantly improve your learning efficiency!
            </p>
          </motion.div>
        </motion.div>
      </div>

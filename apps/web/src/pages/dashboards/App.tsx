...
// ---- helper: allow tutor access if any tutor flags/role are present
function canSeeTutorMenusLocal(user: any, profile: any): boolean {
  const uRole = user?.role;
  const pRole = profile?.role;
  const isTutorRole = uRole === "tutor" || pRole === "tutor";
...
function ProtectedRoute({ children, requiredRole }: ProtectedRouteProps) {
  ...
  // Special case: tutor routes accept either explicit tutor role OR tutor feature flags

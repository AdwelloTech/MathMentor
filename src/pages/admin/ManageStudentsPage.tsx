...
const ManageStudentsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (filterPackage !== 'all') {
      filtered = filtered.filter(student => student.package === filterPackage);
    }
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                              student.package === 'gold' ? 'bg-yellow-100 text-yellow-800' :
                              student.package === 'silver' ? 'bg-gray-100 text-gray-800' :
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div><strong>Grade Level:</strong> {selectedStudent.grade_level}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <div className="text-lg font-semibold text-gray-900">
                          {getPackageInfo(selectedStudent.package)?.display_name || selectedStudent.package}
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="text-lg font-semibold text-gray-900">
                          {getPackageInfo(selectedStudent.package) ? 
                            formatCurrency(getPackageInfo(selectedStudent.package)!.price_monthly) : 
                            'Free'
                          }
                        </div>
                      </div>
                      ...
                      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="text-sm text-gray-900">
                            {formatDate(selectedStudent.subscription_start_date)}
                          </div>
                        </div>
                        <div>
                    ...
                    {getPackageInfo(selectedStudent.package)?.features && (
                      <div className="mt-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {getPackageInfo(selectedStudent.package)!.features.map((feature, index) => (
                            <span
                              key={index}

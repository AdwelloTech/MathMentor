...
const { Schema } = mongoose;
  ...
  package_type: { type: String, enum: ['free','silver','gold'], required: true, unique: true },
...
,
      {
        ...
        collection: 'package_pricing'
      }
    );
    export default mongoose.models.PackagePricing || mongoose.model('PackagePricing', schema);

...
const ManageSubjectsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#D5FFC5] relative overflow-hidden">
      ...
      <div className="px-4 sm:px-6 pb-16 pt-4 sm:pt-6 relative z-10">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {!creating ? (
              <button
                onClick={startCreate}
                className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors w-full sm:w-auto justify-center"
              >
